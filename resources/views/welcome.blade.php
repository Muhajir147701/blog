...
<body>
    ...
    <div class="menusamping">
        <ul>
            <li class='btn btn-success'><a href="{{ url('/') }}">Beranda</a> </li>
            <li class='btn btn-success'><a href="{{ url('/informasi') }}">Informasi Sekolah</a> </li>
            <li class='btn btn-success'><a href="{{ url('/mading') }}">Mading Siswa</a> </li>
            <li class='btn btn-success'><a href="{{ url('/info') }}">Informasi Siswa</a> </li>
            <li class='btn btn-success'><a href="{{ url('/jadwal') }}">Jadwal & Kalender</a> </li>
            <li class='btn btn-success'><a href="{{ url('/pustaka') }}">Pustaka</a> </li>
            <li class='btn btn-success'><a href="{{ url('/tendik') }}">Pendidik & Tendik</a> </li>
            <li class='btn btn-success'><a href="{{ url('/psb') }}">Pendaftaran Siswa Baru</a> </li>
